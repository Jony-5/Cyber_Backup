...
def bin_dec(b): # is a binary string
	d = 0 # is the return decimal value (base 10)
...
def cidr_subnet(cidr):
	n = 32 - int(cidr) #n counts the bits form the left to right
...
"""
This python code takes a CIDR input , converts it to binary, then seperates
the bits into four binary octets. The octets form binary to decimal
"""
